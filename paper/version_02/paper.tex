...
towards the first evolutionary bottleneck.\todo{check and improve
  this}
...
sender strategies in each parameter group, are plotted exemplarily in
Figure~\ref{fig:AverageEUinGroups} for $\beta = 0.1$ and $n_s =
...
arbitrary other language of the same parameter
group. Figure~\ref{fig:AverageEUinGroups}) gives the representative
example of $\toler = 0.1$ and $n_s = 10$. The observation repeats for
other parameter values: while imprecision might decrease the
communicative efficiency of individual languages, it increases the
conceptual coherence and communicative success between independently
evolving strategies. It is almost as if mere confusability of states
imposes a regularity constraint on evolving categories.
