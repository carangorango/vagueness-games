...
better, Section~\ref{sec:iterated-diffusion} looks closer at the novel
diffusion part, before Section~\ref{sec:simulations} explores how
...
parameters, except that imprecision was $\impairment = 0.1$, which is
...
\begin{figure}
  ...
  \includegraphics[width=0.9\textwidth]{plots/MeanMetrics.pdf}
...
under increasing impairment, with the only exception the 6 states
...
\begin{figure}
  ...
  \includegraphics[width=0.9\textwidth]{plots/CategoricalMeasures.pdf}
