...
The main question we should address is whether diffusion and
...
\begin{figure}
  \centering
  \subfloat[][$\ns = 90$, $\toler = 0.2$, $\impairment = 0.1$]{
    \includegraphics[width = 0.5\textwidth]{plots/strat_example_NS-90_tol-2_imp1_ind3501.pdf}
  }
  \subfloat[][$\ns = 90$, $\toler = 0.05$, $\impairment = 0$]{
    \includegraphics[width = 0.5\textwidth]{plots/strat_example_NS-90_tol-005_imp0_ind3002.pdf}
  }

  \subfloat[][$\ns = 10$, $\toler = 0.05$, $\impairment = 0$]{
    \includegraphics[width = 0.5\textwidth]{plots/strat_example_NS-10_tol-005_imp0_ind1001.pdf}
  }
  \subfloat[][$\ns = 6$, $\toler = 0.05$, $\impairment = 0.05$]{
    \includegraphics[width = 0.5\textwidth]{plots/strat_example_NS-10_tol-005_imp005_ind1201.pdf}
  }
