...
introduces the replicator diffusion dynamic. Section~\ref{sec:exploring-rdd} explores the replicator
...
We decided to nevertheless include it since it is related, conceptually interesting, and potentially valuable for future work related to the model introduced in this paper.
...
Development of these ideas, and more, were carried out by \citet{Jager2007:The-Evolution-o,JagerRooijvan-Rooij2007:Language-Struct,JagerMetzger2011:Voronoi-Languag,OConnor2014-OCOEPC}.
