...
approach to others. Appendix~\ref{sec:repl-diff-dynam} provides formal detail.
...
Appendix~XYZ for a derivation of the standard replicator dynamic from this update scheme).
...
focus on the main ideas. Formal detail is provided by Appendix~XYZ. Take a sender who gets to
...
Appendix~XYZ). Eventually, the imitating agent adopts $\messg$ as his choice for $\state$ with
...
Appendix~XYZ shows how imprecise imitation of this sort leads to mean changes in population
