...
$\Rstrat(\state \probbar \messg)$. But if there is, we must take confusability of states into
account. In this sense, the noisy replicator dynamic in (\ref{eq:nRD}) conservatively extends
the classic case in (\ref{eq:RDDiscrete}).
