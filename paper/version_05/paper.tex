...
latter line of thought. We believe that vagueness in language and thought may have many
reasons, not just one. We focus here on one possibility that has not received due attention,
namely imprecise perception of similar stimuli and imprecise realization of similar
responses.
...
biases of the learner may influence which syntactic rules are likely to be inferred from
(finite) parental input. Over the course of many generations, the effects of such transmission
biases can, in a manner of speaking, ``accumulate'' and lead to surprising results, such as the
evolution of compositional form-meaning mappings or the use of regular recursive syntactic
structure. This can happen when the effects of tranmission biases are isolated, as in iterated
learning models
...
behavior. Instead, it leads to the evolution of vague meanings. It moreover unifies and
regularizes evolutionary outcomes, making it appear as if agents were applying inductive biases
or generalizing over partial observations, when in truth this is the sole effect of confusion
of similar stimuli.
...
The World Color Survey project~\citep{CookKay2005:The-World-Color,WCS} collected color naming data for 110 unwritten languages of 45 language families.
...
\footnote{For the concrete case of color categorization, see also \citet{JagerRooijvan-Rooij2007:Language-Struct} and \citet{Correia2015}}
