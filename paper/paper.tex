...
\newcommand{\impairment}{\ensuremath{\alpha_i}} % impairment
\newcommand{\toler}{\ensuremath{\alpha_t}} % tolerance
...
\begin{abstract}
  ...
  which implements a versatile and natural integration of stochastic
  noise in the form of probabilistic confusion of similar stimuli, on
  the one hand, and evolutionary pressure on optimal signal use, on
  the other. Applying the replicator diffusion dynamic to a
