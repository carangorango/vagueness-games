...
data = read.csv('~/Desktop/data/svn/vagueness-games/results/20140916-133324.csv', 
                colClasses=c('numeric','factor','numeric','numeric','numeric',
                             'factor','numeric','numeric','numeric','numeric',
                             'numeric','numeric','numeric','numeric','numeric',
                             'numeric','factor','factor','character','character'))

ds = data[,c(1,4,7,8,9,10,11:16)] # only relevant data
...
pairs(~ Number.of.states + Impairment + Speaker.entropy + Hearer.entropy + Speaker.convexity +
