...
myLabeller <- function(var, value){
    ...
    if (var=="variable") { 
        ...
        value[value=="Speaker.informativity"] <- "informativity"
...
sp = ggplot(dsub, aes(x=Impairment, y=value, color = Number.of.states, shape=Number.of.states, linetype=Number.of.states)) + 
    ...
    scale_shape_discrete(name = "# states") +
    scale_linetype_discrete(name = "# states") +
...
ggsave(sp, file = "paper/plots/MeanMetrics.pdf", width=8, height = 8)
