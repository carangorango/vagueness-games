...
\mf{We should make clear what ``ecological'' means.}
...
What is more important is a smooth and monotonous transition between areas where a message clearly applies and where it clearly does not.
...
From a more encompassing, ecological point of view, learning speed can be an advantage.
