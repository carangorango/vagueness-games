...
\usepackage[natbib=true,style=authoryear-comp,doi=false,url=false,isbn=false]{biblatex}
\bibliography{paper}
...
In order to explore these considerations further, in the remainder of the paper we propose two variations of a multi-population model of imprecise imitation dynamics.
