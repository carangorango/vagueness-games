...
For rationality\todo{clarify}, we need to consider a rational agent's ability to learn from previous experience and to generalize from  the past to the future. 
...
But it suggest that it might be an inflated issue that we need not or should not worry about, because it will not matter for a more general and pressing issue in a more realistic and encompassing picture of language, its use and evolution.
