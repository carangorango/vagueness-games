...
It is intimately related to logically valid deductive inference.  
...
An agent's mental representation of the decision situation can also be subject to considerations of rationality. 
...
We can say that an agent is more or less \emph{strategically rational} depending on the extent to which he is able to anticipate the actions and beliefs of other agents, and to predict medium/long term gains from repeated play.
Strategic rationality is important for language use, because it is natural to assume that an agent's beliefs about how an expression is used normally or how it ought to be used properly will depend, at least in part, on beliefs about how others use said expression.
...
A choice mechanism is a general way of behaving.
...
Within this landscape of aspects of rationality, it seems that the classical picture of meaning is intimately related to a procedural account of rationality, where agents are pretty much omniscient.
Logically valid inference is important.
The sorites paradox is a real threat.
Questions of how language is used or in which sense it is used rationally do not really come to the fore, since the analysis is typically both atemporal and abstracts away from individual language users.
Let us know look into signaling games as another framework for the study of language use and meaning and see what account of rationality is characteristic of that approach.
