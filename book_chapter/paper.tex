...
%Following this idea, we here survey proposals for addressing vagueness in the context of signaling games and suggest.
...
The verdict over the rationality of certain choices can vary depending on how accurate and complete an agent's knowledge is of its environment, the goals to be achieved, the choices or rules available, the relation between those choices and the objectives, and so forth.
...
%This will be important later.
Still, confirming Lipman's argument, there is no vagueness in any such optimal language.
...
The resulting evolutionary dynamic has two layers: first, signaling strategies change by imprecise imitation following the model of~\textcite{franke_vagueness_2017}; second, there is higher-order evolutionary selection of the level of precision used by agents in their imitation of others' strategies.
...
This also implies that population proportions do not play a role in this level of selection.
